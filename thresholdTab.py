...
class Threshold(QWidget):
    def __init__(self, parent): 
        ...
        self.layout.addWidget(titleBitsLayoutW)
        self.layout.addWidget(initButtonsLayoutW)
        self.layout.addWidget(generateButton)
    ...
    def bitsFileClicked(self):
        ...
        if self.bitsFromFileButton.exec():
            ...
            with f:
                ...
                if int(data) < 1:
                    self.statusText.setStyleSheet('color: red')
                    self.statusText.setText("Number of bits cannot be lower than 1")
                    QtTest.QTest.qWait(3000)
                    self.statusText.setStyleSheet('color: black')
                    self.statusText.setText("Set parameters above or choose a config file")
                    return
    ...
    def encyptClicked(self, regSizes = None, regValues = None):
    ...
    def infoWindow(self):
        ...
        f = open("info1.txt", "r", encoding='utf8')
        text = f.read()
        infoW.setText(text)
